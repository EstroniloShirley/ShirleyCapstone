...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
  <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white dark:bg-gray-900">
      <div>
          ...
          <!-- Dropdown menu -->
          {{-- <div id="dropdownAction" class="z-10  bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
              <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                  <li>
                      <a href="{{route('appointments.create-mon')}}" class="block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Monday</a>
                  </li>
                  <li>
                      <a href="{{route('appointments.create-tue')}}" class="bg-green-100 block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Tuesday</a>
                  </li>
                  <li>
                      <a href="{{route('appointments.create-wed')}}" class=" block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Wednesday</a>
                  </li>
                  <li>
                      <a href="{{route('appointments.create-thu')}}" class="block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Thursday</a>
                  </li>
                  <li>
                      <a href="{{route('appointments.create-fri')}}" class="block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Friday</a>
                  </li>
                  <li>
                      <a href="{{route('appointments.create-sat')}}" class="block px-4 py-2 hover:bg-green-100 dark:hover:bg-gray-600 dark:hover:text-white">Saturday</a>
                  </li>
              </ul>
